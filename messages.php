<?php 
    ...
    $messages = DB::query('SELECT * FROM messages WHERE userid = :userid', array(':userid'=>$userid));
?>
<!DOCTYPE html>
<html>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <li class="nav-item">
              <a class="nav-link" href="examples/login.html">
                ...
                <span class="nav-link-text">LoginOut</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Notification/Alerts</h3>
            </div>
            <!-- Light table -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                      ...
                      <?php
                 foreach ($messages as $title) {
                     $admin = DB::query('SELECT username FROM admin WHERE id = :userid', array(':userid' => $title['adminId']));
                   echo "
